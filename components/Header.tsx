...
export default function Header({}: Props) {
  return (
    <header className="sticky  top-0 p-5 flex items-start justify-between max-w-7xl mx-auto z-20 xl:items-center">
      ...
      >
        <SocialIcon
          url="https://github.com/KurtReti"
          fgColor="#FFFFFF"
          bgColor="transparent"
        />
        <SocialIcon
          url="https://www.linkedin.com/in/kurt-reti-aa469924a/"
          fgColor="#FFFFFF"
          bgColor="transparent"
        />
        <SocialIcon
          url="https://twitter.com/KurtReti"
          fgColor="#FFFFFF"
          bgColor="transparent"
        />
      </motion.div>
      ...
      <Link href="#contact">
        ...
        >
          ...
          <p className="hidden uppercase text-white pt-[3px] md:block">
            Get in touch
          </p>
        </motion.div>
      </Link>
