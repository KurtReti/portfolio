      ...
      >
        <div className="w-full justify-start flex flex-col md:flex-row md:space-y-0 md:space-x-4">
          <p className="flex flex-col mb-2 md:w-1/2">
            ...
            <input
              className="text-sm  py-1 px-2 font-light bg-transparent border-b border-white "
              type="text"
              name="name"
              required
            />
        ...
        <div className="flex  align space-y-4 md:space-y-0 flex-col  mt-4">
          <label
            className="self-start uppercase font-light mb-0 md:mb-4 tracking-widest"
            htmlFor="message"
          >
            Message
          </label>
          <textarea
            className="px-2 py-2 self-center text-sm bg-transparent font-light border  border-white w-[300px] md:w-full h-80 md:h-48 "
            name="message"
            required
          />
        </div>
        <motion.button
          ...
          className="border  h-8 mt-4 md:mt-8 w-1/2 self-center border-white px-4 py-1 uppercase font-light"
          onClick={showAlert}
        >
          Submit
        </motion.button>
